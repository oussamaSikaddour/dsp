        ...
        <div class="table__form__inputs">
            ...
            <div class="column center"
                    ...
                    <x-core.file-input
                        ...
                        types="img"
                        type="file"
                        :text="__('forms.image.real_image')"
                    />
                ...
                @if($temporaryImageUrl)
                    <div class="preview mt-3">
                        <img src="{{ $temporaryImageUrl }}" alt="Referral Letter">
                    </div>
                @endif
                            ...
                            <tr wire:key="img-{{ $img->id }}" scope="row">
                                ...
                                <td>
                                    ...
                                    <x-core.button variant="danger" icon="delete" function="openDeleteImageDialog"
                                        :parameters="[$img->id]" rounded=true hasTooltip=true :tooltip="__('toolTips.image.delete')" />
