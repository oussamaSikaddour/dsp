...
use App\Http\Middleware\Web\Core\CanAny;
            ...
            Route::middleware('web')->group(function () {
                foreach (
                    [
                        ...
                        //app
                        'routes/web/app/superAdmin.php',
                        'routes/web/app/admin.php',
                        'routes/web/app/user.php',
                        'routes/web/app/establishmentAdmin.php',
                        'routes/web/app/serviceCoordinator.php',
                        'routes/web/app/medicalSectary.php',
                        'routes/web/app/appointmentsLocationAgent.php',
                        'routes/web/app/doctor.php',
                    ] as $file
                ) {
