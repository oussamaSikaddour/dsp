...
Route::group(['middleware' => ['auth', 'maintenance', 'web.account.active', 'can:admin-access']], function () {
    ...
    Route::get('/ManageEstablishments', [AdminController::class, 'showManageEstablishmentsPage'])
        ->name(RoutesNames::ESTABLISHMENTS_ROUTE->value);
    Route::get('/ManageEstablishment', [AdminController::class, 'showManageEstablishmentPage'])
