...
public function existingRoles()
{
            ...
            $restrictions = [
                'super_admin' => ['commands_destination_manager', 'commands_destination_approver', 'store_manager'],
                'admin' => ['commands_destination_manager', 'commands_destination_approver', 'store_manager'],
