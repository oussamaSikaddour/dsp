...
class WilayatesTable extends Component
{
    ...
    public function updated(string $property): void
    {
        if ($property === "excelFile") {
            $errorsFileData = $this->whenExcelFileUploaded('App\wilayatesImport', __('tables.wilayates.excel.upload.success'));
    ...
    {
        return view('livewire.app.super-admin.wilayates-table');
    }
}
