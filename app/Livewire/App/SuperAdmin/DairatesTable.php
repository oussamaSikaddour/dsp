...
public function dairates()
{
    ...
    public function updated(string $property): void
    {
        if ($property === "excelFile") {
            $errorsFileData = $this->whenExcelFileUploaded('App\dairatesImport', __('tables.dairates.excel.upload.success'),[$this->wilayaId]);
    ...
    {
        return view('livewire.app.super-admin.dairates-table');
    }
}
